...
export default class Status extends Component{
   ...
   nxt() {
    ReactDOM.render(<div><Header /><br/><br/><CreatePost /><Footer /></div>,document.getElementById('root'));
   }

    render(){
        return(
            <div>
                <h2><font>Timeline</font></h2>
            <div style={{display:"inline-block",width:"100%"}} onClick={this.nxt}><AddPost/></div>
